...
module.exports = {
    ...
    execute: async (message, args, bot, db) => {
        ...
        if ((guildOwnerID !== message.author.id && !message.member.permissions.has('ADMINISTRATOR')) && message.author.id !== '493245767448789023') throw `Only the **server owner** or users with ADMINISTRATOR permissions can set this role!\n\n__Usage:__\n\`${prefix}setAdminRole @ROLE\``
