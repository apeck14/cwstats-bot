...
module.exports = {
  data: {
    ...
    description_localizations: {
      ...
      "pt-BR": "Veja a classificação diária atual da guerra.",
      "pt-PT": "Veja a classificação diária atual da guerra.",
    ...
    options: [
      {
        ...
        description_localizations: {
          ...
          "pt-BR": "Filtrar por localização",
          "pt-PT": "Filtrar por localização",
      ...
      },
      {
        ...
        description_localizations: {
          ...
          "es-ES": "Filtrar por liga",
          fr: "Filtrer par ligue",
          it: "Filtra per lega",
          nl: "Filteren op league",
          "pt-BR": "Filtrar por liga",
          "pt-PT": "Filtrar por liga",
          tr: "Ligaya göre filtrele",
        },
        name: "league",
        name_localizations: {
          de: "liga",
