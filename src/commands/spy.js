...
module.exports = {
  data: {
    ...
    description_localizations: {
      ...
      "pt-BR": "Veja os decks de guerra do seu oponente.",
      "pt-PT": "Veja os decks de guerra do seu oponente.",
    ...
    options: [
      {
        ...
        description_localizations: {
          ...
          "pt-BR": "Pesquisar por tag do jogador",
          "pt-PT": "Pesquisar por tag do jogador",
      ...
      },
      {
        ...
        description_localizations: {
          ...
          "pt-BR": "Pesquisar por nome do jogador",
          "pt-PT": "Pesquisar por nome do jogador",
